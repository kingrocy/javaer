...
public class HBaseUtils {
    ...
    static {
        ...
        // 如果是集群 则主机名用逗号分隔
        configuration.set("hbase.zookeeper.quorum", "172.16.16.48,172.16.16.58,172.16.16.59");
        try {
...
//        boolean table = createTable("animals", Lists.newArrayList("dog", "cat"));
